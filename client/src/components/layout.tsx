...
import { LayoutDashboard, UploadCloud, Menu, X, LogOut, User as UserIcon } from "lucide-react";
    ...
    <div className="flex flex-col h-full">
      <div className="p-6 border-b border-sidebar-border">
        <div className="flex flex-col items-center gap-3">
          ...
          <span className="text-xs font-bold tracking-widest text-center text-white">ALKHAT ALNAQQIL</span>
        </div>
      </div>
